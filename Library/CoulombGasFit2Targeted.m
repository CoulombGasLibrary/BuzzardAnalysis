% Next-to-nearest neighbour spacing fit for Coulomb, where a starting point
% is used to increase the speed of the fit. This method may miss the global
% minimum if several local ones exist.

function [BetaFit,ksDist] = CoulombGasFit2Targeted(StartingPoint,Nc,Nsteps,Nconf,ep,DistSave,BetMin,BetMax,BetStep)
